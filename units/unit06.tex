		...
		\section{Order Relations}
			\subsection{Weak Partial Order}
				...
				\begin{exercise}{Activity \thechapter.4}
					\question{Determine whether the following relations are weak partial orders.}
					\begin{enumerate}[label=(\alph*)]
						\item \question{Let $A = \bigl\{a, b, \{a, b\}\bigr\}$. $S$ is the relation on $A$ defined by $(c, B) \in S$ iff $c \in B$.}
							\begin{align*}
							...
							\end{description}
						\item \question{$R \subseteq \mathbb{Z} \times \mathbb{Z}$ such that $x \, R \, y$ iff $x + y$ is even.}\\
							...
							\end{description}
							\pagebreak
						\item \question{$R$ on $\mathbb{Z} \times \mathbb{Z}$ by $(a, b) \,R \, (c, d)$ if either $a < c$ or $(a = c$ and $b \leq d)$.}
							\begin{description}
			...
			\subsection{Strict Partial Order}
				...
				\begin{exercise}{Activity \thechapter.5}
					\question{Determine whether the following relations are strict partial orders.}
					\begin{enumerate}[label=(\alph*)]
						\item \question{$A = \bigl\{a, \{a\}, \{b\}\bigr\}$ and the relation $S$ on $A$ is $S = \Bigl\{\bigl(a, \{a\}\bigr), \bigl(a, \{b\}\bigr)\Bigr\}$}
							\begin{description}
								\item[Irreflexivity] Is it true that $(x, x) \notin S$ for any $x \in A$?\\
							...
							\end{description}
						\pagebreak
						\item \question{$R \subseteq (\mathbb{Z} \times \mathbb{Z}) \times (\mathbb{Z} \times \mathbb{Z})$ such that $(a, b) \, R \, (c, d)$ iff $a < c$.}
							\begin{description}
			...
			\subsection{A Total (or Linear) Order Relation}
				...
				\begin{exercise}{Self Assesmment \thechapter.7}
					\begin{enumerate}
						\item \question{Let $X = \{a, b, c\}$. Write down all strict partial orders on $X$. Which of them are linear?}
							...
							\end{description}
						\item \question{In each of the following cases, determine whether or not $R$ is some sort of order relation on the given set $X$. Justify your answer.}
							\begin{enumerate}[label=(\alph*)]
								\item \question{$X = \bigl\{\emptyset, \{0\}, \{2\}\bigr\}$ and $R = \Bigl\{\bigl(\emptyset, \{0\}\bigr), \bigl(\emptyset, \{2\}\bigr)\Bigr\}$}\\
									...
									\end{proof}
								\tcbbreak
								\item \question{$X = \Bigl\{\emptyset, \{\emptyset\}, \bigl\{\{\emptyset\}\bigr\}\Bigr\}$ and $R = \subseteq$. (That is, each first coordinate is a subset of the second coordinate)}\\
									...
									\end{proof}
							\end{enumerate}
						\item \question{$X = \mathbb{Z}$ and $R = \leq$}\\
							...
							\end{proof}
						\item \question{$X = \mathbb{Z}$ and $R = >$}\\
							...
							\end{proof}
						\pagebreak
						\item \question{$X \in \mathbb{Z}^{+}$ and $x \, R \, y$ iff $x$ divides into $y$ with zero remainder. $y = kx$ for some $k \in \mathbb{Z}^{+}$. $x$ is a \emph{factor} of $y$ and $y$ is a \emph{muliple} of $x$.}\\
		...
		\section{Equivalence Relation}
			...
			\subsection{Equivalence Class}
				...
				\begin{exercise}{Self-Assessment Exercise \thechapter.10}
					\begin{enumerate}
						\item \question{Let $X = \{a, b, c\}$. Write down all equivalence relations on $X$}.\\
							...
							\begin{description}
								...
								\item[All equivalence relations]
									...
									\end{align*} 
							\end{description}
						\item \question{Determine whether the following relations $R$ on $X$ are equivalence relations. If they are, describe the equivalence classes of $R$}.
							\begin{enumerate}[label=(\alph*)]
								\item \question{$X = \{a, b, c\}$ and $R = \bigl\{(c, c), (b, b), (a, a)\bigr\}$}
									\begin{description}
									...
									\end{description}
								\pagebreak
								\item \question{$ X = \{a, b, c\}$ and $R = X \times X$}
									\begin{align*}
									...
									\begin{description}
										...
										\item[Equivalence classes] \moveup
											...
											\end{align*}   
									\end{description}
								\item \question{$X = \mathcal{P}(Y)$ where $Y = \{1, 2, 3\}$ and $R$ consists of all pairs $(C, D)$ such that $C \cap \{2\} = D \cap \{2\}$} \moveup
									\begin{align*}
										X &= \mathcal{P}(Y)\\
									...
									\end{description}
							\end{enumerate}
						\item \question{Let $R$ be the relation on $\mathbb{Z}$ such that $(x, y) \in R$ iff $x - y$ is a multiple of $4$.}\\
							$R = (x, y) \in \mathbb{Z}$ such that $ x - y = 4k$, where $k \in \mathbb{Z}$.
							\begin{enumerate}[label=(\alph*)]
								\item \question{Do tests on $R$ for all of the following properties: reflexivity, irreflexivity, symmetry, antisymmetry, transitivity, and trichotomy.}
									\begin{description}
										...
										\item[Trichotomy] Is every element in $\mathbb{Z}$ related to every other element in $\mathbb{Z}$? No.
											...
											\end{proof}
									\end{description}
								\item \question{What kind of relation is $R$?}\\
								$R$ is an equivalence relation.
								\pagebreak
								\item \question{If $R$ is an equivalence relation, give the equivalence classes of $R$ and show some members of each class.}
									\begin{align*}
										[x] &= \{y \mid (x, y) \in R\}\\
										&= \{y \mid x - y = 4k\}\\
										&= \{y \mid y = x - 4k\}\\
							...
							\end{enumerate}
						\item \question{Suppose $\mathbb{Q}^{+}$ is the set of all positive quotients $\frac{m}{n}$, where $m, n \in \mathbb{Z}^{+}$. That is, $\mathbb{Q}^{+}$ is the set of positive rational numbers. Let $R$ be the relation on $\mathbb{Q}^{+}$ defined by the rule $(x, y) \in R$ iff $y = \frac{a}{b}\bigl(x\bigr)$ for some $a, b \in \mathbb{Z}^{+}$. Prove that $R$ is an equivalence relation, and show the equivalence classes of $R$.}\\
							...
							\end{description}
						\pagebreak
						\item \question{Prove that if $R$ is a relation on $\mathbb{Z}^{+}$, then $R$ is symmetric iff $R = R^{-1}$.}
							\begin{proof}
								$ $
								\begin{enumerate}[label=(\roman*)]
									\item \question{If $R$ is symmetric, then $R = R^{-1}$.}
										\begin{subproof}
										...
										\end{subproof}
									\item \question{If $R = R^{-1}$, then $R$ is symmetric.}
										\begin{subproof}
											Assume $R = R^{-1}$.
											\begin{tabbing}
												Suppose \quad \= $(x, y) \in R$.\\
			...
			\subsection{Partitions}
				\begin{definition}{Partition}
					For a nonempty set $A$, a \concept{partition} of $A$ is a set $S = \{S_{1}, S_{2}, S_{3}\}$. The members of $S$ are subsets of $A$ (called \emph{parts} of $A$) such that:
					\begin{enumerate}
				...
				\subsubsection{Going Backwards From a Partition}
					...
					\begin{exercise}{Self Assessment Exercise \thechapter.12}
						\question{Determine whether $P$ is a partition of $X$ in each of the following cases. If it is, describe the corresponding equivalence relation.}
						\begin{enumerate}[label=(\alph*)]
							\item \question{$X = \{1, 2, 3\}$ and $P = \bigl\{\emptyset, \{1\}, \{2, 3\}\bigr\}$.}\\
								$P$ is \emph{not} a partition of $X$, as $\emptyset$ is one of the elements of the set.
							\item \question{$X = \{1, 2, 3\}$ and $P = \bigl\{\{1\}, \{2\}, \{1, 3\}\bigr\}$.}\\
								$P$ is \emph{not} a partition of $X$, as $1$ appears in two different elements.
							\item \question{$X = \{1, 2, 3\}$ and $P = \bigl\{\{1, 3\}, \{2\}\bigr\}$.}\\
							...
							\item \question{$X = \{1, 2, 3\}$ and $P = \bigl\{\{1\}, \{2\}\bigr\}$}\\
								$P$ is \emph{not} a partition of $X$, as not all the members of $X$ are included.
							\item \question{$X = \mathbb{Z}$ and $P = \bigl\{\{0\}, \mathbb{Z}^{+}, \mathrm{Neg}\bigr\}$ where $\mathrm{Neg} = \{x \mid x \in \mathbb{Z}$ and $ x < 0\}$.}\\
								$P$ \emph{is} a partition of $X$.\\
								...
								\end{align*}
							\item \question{$X = \mathbb{Z}$ and $P = \bigl\{[0], [1], [2], [3], [4]\bigr\}$, where $[n] = \{x \mid x - n$ is divisible by $5$ with zero remainder$\}$ and $n \in \{0, 1, 2, 3, 4\}$.}\\
								$P$ \emph{is} a partition of $X$.\\
								The equivalence relation is:
								\begin{align*}
		...
		\section{Functions}
			...
			\subsection{Function}
				...
				\begin{exercise}{Self Assessment Exercise \thechapter.14}
					\begin{enumerate}
						\item \question{Give $5$ functions from $A = \{1, 2, 3, 4\}$ to $B = \{a, b, c\}$.}
							\begin{align*}
							...
							\end{align*}
						\item \question{Give all the functions from $A = \{a, b\}$ to $B = \{5, 6, 7\}$.}
							\begin{alignat*}{3}
							...
							\end{alignat*}
						\item \question{Give $3$ functions from $A \times A$ to $B$ if $A = \{a, b\}$ and $B = \{5, 6, 7\}$.}
							\begin{align*}
							...
							\end{align*}
						\item \question{Let $R$ be a relation on $A = \bigl\{1, 2, 3, \{1\}, \{2\}\bigr\}$ defined by \\$R = \Bigl\{\bigl(1, \{1\}\bigr), \bigl(1, 3\bigr), \bigl(2, \{1\}\bigr), \bigl(2, \{2\}\bigr), \bigl(\{1\}, 3\bigr), \bigl(\{2\}, \{1\}\bigr)\Bigr\}$.}
							\begin{enumerate}[label=(\alph*)]
								\item \question{Is $R$ a function from $A$ to $A$?}\\
								...
								\item \question{Is $\mathrm{ran}(R)$ equal to the codomain of $R$?}\\
									No. $1 \in$ codomain, but $1 \notin \mathrm{ran}(R)$.
							\end{enumerate}
						\pagebreak
						\item \question{Consider the set $\mathcal{P}(A) = \bigl\{\emptyset, \{a\}, \{b\}, \{c\}, \{a, b\}, \{a, c\}, \{b, c\}, \{a, b, c\}\bigr\}$. Show that the relations $f$, $g$ and $h$ described below are functional and have as domains $\mathcal{P}(A)$, $\mathcal{P}(A) \times \mathcal{P}(A)$, and $\mathcal{P}(A) \times \mathcal{P}(A)$ respectively.}
							\begin{enumerate}[label=(\alph*)]
								\item \question{Let $f = \bigl\{(x, y) \mid x, y \in \mathcal{P}(A)$ and $y = x' \bigr\}$}.
									\begin{description}
										...
										\item[Domain] The domain of $f$ is equal to the input set $\mathcal{P}(A)$.
											...
											\end{proof}
									\end{description}
								\item \question{Let $g = \Bigl\{\bigl((u, v), y\bigr) \mid (u, v) \in \mathcal{P}(A) \times \mathcal{P}(A)$ and $y = u \cup v\Bigr\}$}.
									\begin{description}
									...
									\end{description}
								\pagebreak
								\item \question{Let $h = \Bigl\{\bigl((u, v), y\bigr) \mid (u, v) \in \mathcal{P}(A) \times \mathcal{P}(A)$ and $y = u \cap v\Bigr\}$}.
									\begin{description}
									...
									\end{description}
							\end{enumerate}
						\item \question{For each of the following relations from $X$ to $Y$, determine whether or not the relation may be regarded as a function from $X$ to $Y$.}
							\begin{enumerate}[label=(\alph*)]
								\item \question{$X = Y = \mathbb{Z}$ and $R = \bigl\{(x, y) \mid y = x\bigr\}$.}\\
									$R$ is a function.
									\begin{proof}
										$ $
										\begin{description}
								...
								\item \question{$X = Y = \mathbb{Z}$ and $R = \bigl\{(x, y) \mid y = 3 - x\bigr\}$.}\\
									...
									\end{proof}
								\pagebreak
								\item \question{$X = Y = \mathbb{Z}$ and $R = \bigl\{(x, y) \mid y = \sqrt{x}\bigr\}$. (That is, the positive square root of $x$.)}\\
									...
									\end{proof}
								\item \question{$X = Y = \mathbb{Z}$ and $R = \bigl\{(x, y) \mid y^{2} = x\bigr\}$.}\\
									$R$ is not a function.
									\begin{proof}
										$ $
										\begin{description}
									...
									\end{proof}
								\pagebreak
								\item \question{$X = Y = \mathbb{R}$ and $S = \bigl\{(x, y) \mid x^{2} + y^{2} = 1\bigr\}$.}
									$R$ is not a function.
									\begin{proof}
										$ $
										\begin{description}
									...
									\end{proof}
							\end{enumerate}
						\item \question{Is the relation $R$ on $\mathbb{Z}^{+}$, which consists of all pairs $(x, y)$ such that $y = x - 1$, a function from $\mathbb{Z}^{+}$ to $\mathbb{Z}^{+}$?}\\
							No.
							\begin{proof}
								$ $
								\begin{description}
							...
							\end{proof}
						\pagebreak
						\item \question{Let $A = \{a, b, c\}$. Consider all the equivalence relations on $A$. How many relations are also functions from $A$ to $A$?}
							\begin{description}
							...
							\end{description}
						\item \question{Let $A = \{a, b, c\}$.}
							\begin{enumerate}[label=(\alph*)]
								\item \question{How many weak partial orders on $A$ are also functions from $A$ to $A$?}\\
								...
								\item \question{How many strict partial orders on $A$ are also functions from $A$ to $A$?}\\
