				...
				\begin{exercise}{Self Assesmment \thechapter.7}
					\begin{enumerate}
						\item \question{Let $X = \{a, b, c\}$. Write down all strict partial orders on $X$. Which of them are linear?}
							...
							\end{description}
						\item \question{In each of the following cases, determine whether $R$ is some sort of order relation on the given set $X$. Justify your answer.}
							\begin{enumerate}[label=(\alph*)]
						...
						\item \question{$X = \mathbb{Z}$ and $R = >$}\\
							...
							\end{proof}
						\pagebreak
						\item \question{$X \in \mathbb{Z}^{+}$ and $x \, R \, y$ iff $x$ divides into $y$ with zero remainder. $y = kx$ for some $k \in \mathbb{Z}^{+}$. $x$ is a \emph{factor} of $y$ and $y$ is a \emph{multiple} of $x$.}\\
				...
				\begin{exercise}{Self-Assessment Exercise \thechapter.10}
					\begin{enumerate}
						...
						\item \question{Let $R$ be the relation on $\mathbb{Z}$ such that $(x, y) \in R$ iff $x - y$ is a multiple of $4$.}\\
							...
							\begin{enumerate}[label=(\alph*)]
								\item \question{Do tests on $R$ for all the following properties: reflexivity, irreflexivity, symmetry, antisymmetry, transitivity, and trichotomy.}
									\begin{description}
						...
						\item \question{Consider the set $\mathcal{P}(A) = \bigl\{\emptyset, \{a\}, \{b\}, \{c\}, \{a, b\}, \{a, c\}, \{b, c\}, \{a, b, c\}\bigr\}$. Show that the relations $f$, $g$ and $h$ described below are functional and have as domains $\mathcal{P}(A)$, $\mathcal{P}(A) \times \mathcal{P}(A)$, and $\mathcal{P}(A) \times \mathcal{P}(A)$ respectively.}
							\begin{enumerate}[label=(\alph*)]
								...
								\item \question{Let $h = \Bigl\{\bigl((u, v), y\bigr) \mid (u, v) \in \mathcal{P}(A) \times \mathcal{P}(A)$ and $y = u \cap v\Bigr\}$}.
									...
									\end{description}
							\end{enumerate}
						\item \question{For each of the following relations from $X$ to $Y$, determine whether the relation may be regarded as a function from $X$ to $Y$.}
							\begin{enumerate}[label=(\alph*)]
