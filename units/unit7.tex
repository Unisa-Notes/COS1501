	...
	\chapter{More About Functions}
		\section{The range of a function}
			...
			\subsection{Determining the range of a function}
				...
				\begin{enumerate}
					\item Write the defintion of the function ($f(x)$), and the domain.
		...
		\section{Surjectivity (MAPPING)}
			...
			\begin{examplebox}
				...
				\end{description}
			\end{examplebox}
		\section{Injectivity (ONE TO ONE)}
			...
			\begin{examplebox}
				...
				\end{description}
			\end{examplebox}
			\subsection{Determine whether an abstract function is injective}
		...
		\section{Bijective and invertible functions}
			\subsection{Inverse Relation (RECAP)}
