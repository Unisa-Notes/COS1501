	...
	\chapter{Proofs Involving Sets}
		...
		\section{Proofs on Specific Sets}
			...
			\begin{exercise}{Self Assessment Exercise \thechapter.12}
				\begin{enumerate}
					\item \question{Determine whether or not for $V$, $W$, $Z \subseteq U$, if $V \subseteq W$, then $V \cup Z \subseteq W \cup Z$ and $V \cap Z \subseteq W \cap Z$. Provide either a proof or a counterexample.}\\
					...
					\item \question{Is it the case that, for every subset $X$ of $U$ there exists a subset $Y$ of $U$ such that $X \cup Y = \emptyset$? Justify your answer.}\\
						...
						\end{proof}
					\item \question{Is it the case that, for every subset $X$ of $U$, there is some subset $Y$ such taht $X \cap Y = U$? Justify your answer.}\\
						No.
						\begin{proof}[Counterexample]
							Let $X = \{1,\}$ and $U$ = \{1, 2\}.\\
							The possible subsets of $U$ are $\emptyset$ or \{1\} or \{2\} or \{1, 2\}.
