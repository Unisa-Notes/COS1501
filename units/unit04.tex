...
\begin{document}
	...
	\chapter{Proofs Involving Sets}
		...
		\pagebreak
		\begin{exercisebox}{Self Assessment Exercise \thechapter.8}
			\begin{enumerate}
		...
		\section{The Inclusion Exclusion Principle}
			...
			\subsection{Applying the principle to Venn Diagrams}
				...
				\begin{examplebox}
					...
					\end{alignat*}
					\begin{center}
						\begin{venndiagram3sets}[showframe=true, radius=3.5cm, overlap=2.3cm, vgap=1cm, labelA={$J$}, labelB={$A$}, labelABC={$1$}, labelOnlyAC={$1 - 1 = 0$}, labelOnlyBC={$5-1 = 4$}, labelOnlyAB={$6 - 1 = 5$}, labelOnlyA={$45 - 5 - 1 - 0 = 39$}, labelOnlyB={$30 - 5 - 1 - 4 = 20$}, labelOnlyC={$20 - 0 - 1 - 4 = 15$}]
							\fillAll[fill=white]
							\setpostvennhook
							{
				...
				\begin{exercisebox}{Self Assessment Exercise \thechapter.10}
					\begin{enumerate}
						\item \textbf{Of $1000$ first year students, $700$ take Mathematics, $400$ take Computer Science, and $800$ take Mathematics or Computer Science.}\\
							...
							\end{alignat*}
							\begin{center}
								\begin{venndiagram2sets}[shade=circle area, showframe=true, radius=2.4cm, overlap=1.2cm, vgap=1cm, labelA={$M$}, labelB={$C$}, labelAB=$x$, labelOnlyA={$700 - x$}, labelOnlyB={$400 - x$}]
									\fillAll[fill=white]
									\setpostvennhook
									{
		...
		\section{Proofs on Specific Sets}
			...
			\begin{notebox}{Any variable can be used for a set description}
			...
			\begin{examplebox}
				...
				\end{proof}
			\end{examplebox}
			\begin{notebox}{Using Or in Proofs}
			...
			\end{notebox}
			\pagebreak
			\begin{exercisebox}{Self Assessment Exercise \thechapter.11}
			...
			\end{exercisebox}
			\pagebreak
			\begin{exercisebox}{Self Assessment Exercise \thechapter.12}
				\begin{enumerate}
