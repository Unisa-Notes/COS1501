		...
		\section{Proofs on Specific Sets}
			...
			\begin{exercise}{Self Assessment Exercise \thechapter.11}
				...
				\begin{enumerate}[itemsep=0.5em]
					\item \textbf{$\{y \in \mathbb{Z}^{+} \mid y$ is an even prime number$\} = \{u \in \mathbb{Z}^{+} \mid u^{2} = 4\}$}\questionspace
						\begin{proof}
							...
							\end{tabbing}
						\end{proof}
					\item \textbf{$\mathcal{P}\bigl(\{0, 1\}\bigr) = \{\emptyset\} \cup \bigl\{\{0\}\bigr\} \cup \bigl\{\{1\}\bigr\} \cup \bigl\{\{0, 1\}\bigr\}$}\questionspace
						\begin{proof}
							...
							\end{tabbing}
						\end{proof}
					\item \textbf{$\{x \in \mathbb{R} \mid x^{2} + 6x + 5 < 0\} = \{x \in \mathbb{R} \mid -5 < x < -1\}$}\questionspace
						\begin{proof}
						...
						\end{proof}
						\pagebreak
					\item \textbf{$\{x \in \mathbb{Z} \mid x^{2} - 5x + 4 < 0\} = \{x \in \mathbb{Z}^{+} \mid x$ is a prime factor of $6\}$}\questionspace
						\begin{proof}
							...
							\end{tabbing}
						\end{proof}
					\item \textbf{$\{x \in \mathbb{R} \mid x^{2} + x - 2 > 0\} = \{x \in \mathbb{R} \mid x < -2$ or $x > 1\}$}\questionspace
						\begin{proof}
			...
			\begin{exercise}{Self Assessment Exercise \thechapter.12}
				\begin{enumerate}[itemsep=0.5em]
					\item \textbf{Determine whether or not for $V$, $W$, $Z \subseteq U$, if $V \subseteq W$, then $V \cup Z \subseteq W \cup Z$ and $V \cap Z \subseteq W \cap Z$. Provide either a proof or a counterexample.}\questionspace
					...
					\item \textbf{Is it the case that, for all subsets $X$, $Y$, $W \subseteq U$, if $X = Y$ and $Y = W$, then $X = W$, and if $X \subset Y$ and $Y \subset W$, then $X \subset W$?}\questionspace
						...
						\end{proof}
					\pagebreak
					\item \textbf{Is it the case that, for all subsets $X$ of $U$, $X \cup \emptyset = X$? Justify your answer.}\questionspace
						Yes.
						\begin{proof}
							$ $
							\begin{tabbing}
						...
						\end{proof}
					\item \textbf{Is it true that for all subsets $V$ and $W$ of $U$, $V \cap W = \emptyset$ iff $V = \emptyset$ or $W = \emptyset$?}\questionspace
						No.
						\begin{proof}
							$ $
							\begin{enumerate}[label=(\roman*)]
						...
						\end{proof}
					\pagebreak
					\item \textbf{Is it the case that, for every subset $X$ of $U$ there exists a subset $Y$ of $U$ such that $X \cup Y = \emptyset$? Justify your answer.}\questionspace
						No.
						\begin{proof}[Counterexample]
							Let $X = \{1,\}$ and $U$ = \{1, 2\}.\\
						...
						\end{proof}
					\item \textbf{Is it the case that, for every subset $X$ of $U$, there is some subset $Y$ such taht $X \cap Y = U$? Justify your answer.}\questionspace
						No.
						\begin{proof}[Counterexample]
							Let $X = \{1,\}$ and $U$ = \{1, 2\}.\\
							The possible subsets of $U$ are $\emptyset$ or \{1\} or \{2\} or \{1, 2\}.
						...
						\end{proof}
					\item \textbf{Using ``if and only if'' statements, prove the following:}\questionspace
						\begin{enumerate}[label=(\alph*)]
