		...
		\section{Quantifiers and Predicates}
			...
			\subsection[Existential Quantifier]{Existential Quantifier (THERE EXISTS)}
				...
				\begin{exercise}{Self Assessment Exercise \thechapter.3}
					\question{Write down the English equivalent of each of the following statements, and give an opinion on whether or not the statement is true.}
					\begin{enumerate}[label=(\alph*)]
						\item \question{$\exists y \in \mathbb{Q}, y = \sqrt{2}$}\\
							There exists some rational number that is the square root of 2. This statement is false, as $\sqrt{2}$ is an irrational number.
						\item \question{$\forall x \in \mathbb{R}, 2x < x^{2}$}\\
							For all real numbers $x$, $2x$ is less than $x^{2}$. This statement is false, as $2(0) \not < 0^{2}$
						\item \question{$\forall x \in \mathbb{Z}, x > 0$}\\
							Every integer is greater than $0$. This statement is false, as $-1$ and $0$ are both integers.
						\item \question{$\exists x \in \mathbb{Z}^{+}, x = 0$}\\
				...
				\begin{exercise}{Self Assessment Exercise \thechapter.4}
					\question{Prove by means of truth tables that\\ $\lnot (p \land q) \equiv (\lnot p) \lor (\lnot q)$}
					\begin{center}
				...
				\begin{exercise}{Self Assessment Exercise \thechapter.5}
					\question{Prove by means of truth tables that\\ $\lnot (p \lor q) \equiv (\lnot p) \land (\lnot q)$}
					\begin{center}
						\begin{tabular}{| c c | c c | c | c | c | c|}
							\hline
			...
			\begin{exercise}{Self Assessment Exercise \thechapter.6}
				\question{Determine the negations of the following quantified statements: (Show all steps.)}
				\begin{enumerate}[label=(\alph*)]
					\item \question{$\forall x \in \mathbb{Z}^{+}, x > 3$}
						\begin{align*}
							\lnot (\forall x \in \mathbb{Z}^{+}, x > 3) &\equiv \exists x \in \mathbb{Z}^{+}, \lnot (x > 3)\\
							& \equiv \exists x \in \mathbb{Z}^{+}, x \leq 3
						\end{align*}
					\item \question{$\exists x \in \mathbb{R}, 2x = x^{2}$}
						\begin{align*}
							\lnot (\exists x \in \mathbb{R}, 2x = x^{2}) & \equiv \forall x \in \mathbb{R}, \lnot(2x = x^{2})\\
							& \equiv \forall x \in \mathbb{R}, 2x \neq x^{2}
						\end{align*}
					\item \question{$\forall x \in \mathbb{Z}, (x > 0) \lor (x^{2} > 0)$}
						\begin{align*}
						...
						\end{align*}
					\item \question{$\exists y \in \mathbb{Z}^{+}, (y \leq 10) \land (y \neq 0)$}
						\begin{align*}
						...
						\end{align*}
					\item \question{$\exists x \in A, P(x) \land Q(x)$}
						\begin{align*}
						...
						\end{align*}
					\item \question{$\forall x \in \mathbb{Z}^{+}, (x \leq 3) \rightarrow (x^{3} \geq 1)$}
						\begin{align*}
			...
			\begin{exercise}{Self Assessment Exercise \thechapter.7}
				\question{For each of (a) to (d) in the previous exercise, determine whether the original statement is true, whether the negation is true, or if neither of the two is true.}
				\begin{enumerate}[label=(\alph*)]
		...
		\section{Proof Strategies}
			...
			\subsection{Vacuous Proofs}
				...
				\begin{exercise}{Self Assessment Exercise \thechapter.10}
					\begin{enumerate}
						\item \question{Prove each of the following statements by direct proof, contrapositive and contradiction respectively.}
							\begin{enumerate}[label=(\alph*)]
								\item \question{If $x^{2} - 3x + 2 < 0$, then $x > 0$.}
									...
									\end{proof}
								\item \question{If $x^{2} - x - 6 > 0$, then $x \neq 1$}.
									\begin{proof}[Direct Proof]
									...
									\end{proof}
								\pagebreak
								\item \question{For all $a, b \in \mathbb{Z}$, if $a + b$ is odd, then exactly one of $a$ or $b$ is odd.}
									\begin{proof}[Direct Proof]
									...
									\end{proof}
								\item \question{For all $x \in \mathbb{Z}$, if $x$ is even, then $x^{2} + 4x + 2$ is even.}
									\begin{proof}[Direct Proof]
									...
									\end{proof}
								\item \question{If $n$ is a multiple of $3$, then $n^{3} + n^{2}$ is a multiple of $3$}
									\begin{proof}[Direct Proof]
									...
									\end{proof}
							\end{enumerate}
						\item \question{Provide a counterexample to show that the statement \\ ``If $x > 0$, then $x^{2} - 3x + 1 < 0$'' is not true for all integers $x > 0$.}\\
